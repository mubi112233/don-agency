...
export default function PhilosophySection({ language }: PhilosophySectionProps) {
      ...
      <div className="space-y-12">
        {t.items.map((item, i) => (
          <div key={i} className="flex gap-8 group">
            <div className="shrink-0 w-16 h-16 rounded-sm bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300">
